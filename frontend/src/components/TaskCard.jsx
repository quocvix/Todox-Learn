...
const TaskCard = ({ task, index, handleTaskChanged }) => {
    ...
    const deleteTask = async (taskId) => {
        try {
            ...
            console.error("Lỗi xảy ra khi delete task", error);
            toast.error("Lỗi xảy ra khi delete task ");
        }
    };
    ...
    const updateTask = async () => {
        try {
            ...
            setIsEditting(false);
            toast.success("Nhiệm vụ cập nhật thành công");
            handleTaskChanged();
        } catch (error) {
    ...
    const toggleTaskCompleteButton = async () => {
        try {
            ...
            console.error("Lỗi xảy ra khi cập nhật status task", error);
            toast.error("Lỗi xảy ra khi cập nhật status task ");
        }
    };
